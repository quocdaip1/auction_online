        ...
        <div class="pt-4 mb-4 mb-lg-3 pb-lg-4 profile-wrapper">
            <div class="row g-4">
                <div class="col-auto">
                    ...
                    @endphp
                        <img src="{{$imageUrl}}" alt="user-img" class="img-thumbnail"
                ...
                <div>
                    <div class="d-flex profile-wrapper">
                        ...
                        <div class="flex-shrink-0">
                            <a href="{{ route('user.editProfile', ['id' => $user->id]) }}" class="btn btn-success"><i
                                                ...
                                                <table class="table table-borderless mb-0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-muted">
                                                                {{ \Illuminate\Support\Carbon::parse($user->created_at)->format('l, F jS Y \a\t') }}
                                    ...
                                    <div class="acitivity-timeline">
                                        ...
                                        <div class="acitivity-item py-3 d-flex">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                ...
                                                <p class="text-muted mb-2">
                                                    <span class="text-danger">2 days left</span> notification to submit
...
@section('script')
    ...
    <script src="{{asset('assets/js/pages/profile.init.js')}}"></script>@endsection
